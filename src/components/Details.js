            ...
            <div className="container py-5">
              ...
              <div className="row">
                ...
                <div className="col-10 mx-auto col-md-8 my-3 text-capitalize">
                  <h2>model: {title}</h2>
                  <h4 className="text-title text-uppercase text-muted mt-3 mb-2">made by: <span className="text-uppecase">{company}</span></h4>
                  ...
                  <ButtonContainer cartBtn disabled={inCart ? true : false} onClick={()=>{
                    value.addToCart(id);
                    value.openModal(id);
                  }}>
                    {inCart ? "in cart": "add to carts"}
                  </ButtonContainer>
                </div>
              </div>
            </div>
